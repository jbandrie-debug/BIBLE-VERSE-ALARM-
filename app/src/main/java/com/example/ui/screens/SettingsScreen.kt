            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Button(
                                onClick = {
                                    val dummyVerse = VerseEntity(
                                        ...
                                        translation = "KJV",
                                        prayer = "Lord Jesus, thank You for giving me strength and guidance today. Amen."
                                    )
                    ...
                    Row(
                        ...
                        val presets = listOf(
                            Triple("preset-old-male", "👴 English Old Man Pastor", 0.65f),
                            Triple("preset-pastor-baritone", "⛪ Pastor Baritone", 0.72f),
                            Triple("preset-soft-female", "👩 Soft Female", 1.10f),
                        ...
                        presets.forEach { (presetId, label, presetPitch) ->
                            ...
                            FilterChip(
                                ...
                                onClick = {
                                    ...
                                    pitch = presetPitch
                                    rate = if (presetId.contains("old") || presetId.contains("male") || presetId.contains("pastor")) 0.80f else 0.90f
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    if (useElevenLabs) {
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text("Custom Voice ID (e.g. Cloned or Voice Library ID)") },
                        ...
                        Button(
                            onClick = {
                                if (elevenLabsApiKey.isBlank()) {
                                    Toast.makeText(context, "Please enter your ElevenLabs API Key first!", Toast.LENGTH_SHORT).show()
                                } else {
                                    val dummyVerse = VerseEntity(
                                        book = "Philippians", chapter = 4, verseNumber = 13,
                                        text = "I can do all things through Christ which strengtheneth me.",
                                        translation = "KJV",
                                        prayer = "Lord Jesus, thank You for Your strength and guidance today. Amen."
                                    )
